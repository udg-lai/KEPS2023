/**
 * @class snowman2sat_cheating_cnf
 * @author Miquel Bofill
 * @version 1.0
 * @date 2023-03-14
 * @brief Translation of "A good snowman is hard to build" instance to CNF; cheating version, just for comparison with planners
*/
...
public class snowman2sat_cheating_cnf {
