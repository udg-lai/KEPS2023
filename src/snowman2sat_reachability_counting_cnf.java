/**
 * @class snowman2sat_reachability_counting_cnf
 * @author Miquel Bofill
 * @version 1.1
 * @date 2023-01-02
 * @brief Translation of "A good snowman is hard to build" instance to CNF, with reachability (without move actions), ensuring acyclicity by counting neighbours in path
*/
...
public class snowman2sat_reachability_counting_cnf {
